...
public class CreateTransactionRequest {
    ...
    @Schema(description = "Número da conta de origem", example = "12345", required = true)
    private Long from;

    @Schema(description = "Número da conta de destino", example = "67890", required = true)
    private Long to;
    ...
    @Schema(description = "Tipo da transação", example = "PIX", required = true)

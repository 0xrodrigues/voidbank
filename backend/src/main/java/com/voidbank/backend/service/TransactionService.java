...
import com.voidbank.backend.validator.TransactionValidatePipeline;
...
public class TransactionService {
    ...
    private final TransactionValidatePipeline transactionValidatePipeline;

    public void transferFunds(Transaction transaction) {
        log.info("transferring funds and creating transaction - {}", transaction);
        transactionValidatePipeline.validate(transaction);
        transaction.fill();
